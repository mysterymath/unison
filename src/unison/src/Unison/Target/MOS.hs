...
import qualified Unison.Target.MOS.SpecsGen as SpecsGen
...
instance Read MOSInstruction where
...
instance Read MOSRegister where
...
instance Show MOSRegister where
  show r = case M.lookup r regStrings of
             (Just s) -> s
             Nothing -> error $ "unmatched: show MOSRegister"
